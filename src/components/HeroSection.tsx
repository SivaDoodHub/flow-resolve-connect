      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-primary-foreground">
        <div className="max-w-4xl mx-auto animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <Button variant="outline" size="lg" className="text-lg px-8 py-6 border-2 border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10">
              Learn More
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <div className="flex flex-col items-center animate-float">
              ...
              <div className="text-primary-foreground/80">Faster Resolution</div>
            </div>
            ...
            <div className="flex flex-col items-center animate-float" style={{ animationDelay: "0.2s" }}>
              ...
              <div className="text-3xl font-bold text-primary-foreground">3 Roles</div>
              <div className="text-primary-foreground/80">Integrated Platform</div>
            </div>
            ...
            <div className="flex flex-col items-center animate-float" style={{ animationDelay: "0.4s" }}>
              ...
              <div className="text-3xl font-bold text-primary-foreground">Real-time</div>
              <div className="text-primary-foreground/80">GPS Tracking</div>
            </div>
          </div>
        </div>
      </div>
